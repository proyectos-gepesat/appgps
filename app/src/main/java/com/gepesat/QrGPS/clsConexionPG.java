...
public class clsConexionPG {
    ...
    public  Connection conexionBD(){
        try{
            ...
            conexion = DriverManager.getConnection("jdbc:postgresql://gepesat-postgresql-do-user-7581876-0.a.db.ondigitalocean.com:25060/defaultdb?sslfactory=org.postgresql.ssl.NonValidatingFactory&ssl=true", "doadmin", "fmawbjj6kmdbc330");
